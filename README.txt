...
packets of 500, and no bidirectionality  (e.g. ./rdtp 25000 0.25 0.25 0.25 500 1 1 0)
...
Since the output of the program for 25,000 packets is extensive, I've provided the required output
